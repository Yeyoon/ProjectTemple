...
bool TextureShader::Initialize(void)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader("Texture.vs", "Texture.ps");
	if(!result)
	{
		return false;
	}
...
bool TextureShader::Render(void)
{
	bool result;
...
void TextureShader::SetIndexCount(int index)
{
	m_currentIndexCount = index;
}

bool TextureShader::InitializeShader(char* vsFilename, char* psFilename)
{
	HRESULT result;
...
void TextureShader::ShutdownShader(void)
{
...
bool TextureShader::SetShaderParameters(void)
{
	HRESULT result;
	...
	deviceContext->PSSetShaderResources(0, 1, &m_currentTexture);

	return true;
}

void TextureShader::RenderShader(void)
{
	ID3D11DeviceContext* deviceContext = Overlord::GetInstance()->GetDeviceContext();
